...
tk.Label(root, text="Annual Interest Rate (%)").grid(row=0, column=0, sticky="e", padx=10, 
pady=5) 
entry_rate = tk.Entry(root) 
entry_rate.grid(row=0, column=1, pady=5) 
 
tk.Label(root, text="Number of Payments").grid(row=1, column=0, sticky="e", padx=10, 
pady=5) 
...
tk.Button(root, text="Calculate", command=calculate_payment).grid(row=4, column=0, 
pady=15) 
